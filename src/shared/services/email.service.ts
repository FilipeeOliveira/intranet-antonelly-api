...
export class LegacyEmailService {
  ...
  async sendTemporaryPasswordEmail(email: string, data: EmailTemplateData): Promise<void> {
  ...
  async sendPasswordResetEmail(email: string, data: EmailTemplateData): Promise<void> {
  ...
  async sendWelcomeEmail(email: string, data: EmailTemplateData): Promise<void> {
