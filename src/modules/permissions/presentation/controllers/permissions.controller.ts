...
export class PermissionsController {
  ...
  assignFeature(@Param("id", ParseUUIDPipe) userId: string, @Param("featureId", ParseUUIDPipe) featureId: string) {
  ...
  assignManyFeatures(@Param("id", ParseUUIDPipe) userId: string, @Body("featureIds") featureIds: string[]) {
